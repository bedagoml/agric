...
if(isset($_POST['btn-register'])){
	$question = $MySQLi_CON->real_escape_string(trim($_POST['question']));
	
	$content = $MySQLi_CON->real_escape_string(trim($_POST['content']));

		$check_content = $MySQLi_CON->query("SELECT * FROM answer WHERE content='$content'");
		$count=$check_content->num_rows;
		if ($count==0) {
			$query = "INSERT INTO answer(question,content) VALUES('$question','$content')";
			if($MySQLi_CON->query($query)){
				
				$messo = "<div class='alert alert-success col-md-10 col-sm-10 col-md-offset-1 col-sm-offset-1'>
				<span class='glyphicon glyphicon-info-sign'></span> &nbsp; Thank you for the answer</div>"; header("refresh:3;advice.php");
				$_SESSION['userSession'] = $content;
				
			}else {
			
				$messo = "<div class='alert alert-danger col-md-10 col-sm-10 col-md-offset-1 col-sm-offset-1'>
					<span class='glyphicon glyphicon-info-sign'></span> &nbsp; Error while giving answer please try again! </div>"; header("refresh:3;advice.php");
			}
		} else{
		
			$messo = "<div class='alert alert-danger col-md-10 col-sm-10 col-md-offset-1 col-sm-offset-1'>
					<span class='glyphicon glyphicon-info-sign'></span> &nbsp; Answer $content already exists please check ! </div>"; header("refresh:3;advice.php");
		}
...
<head>
	...
	<title>Sowing Big Answer to question</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Answer the Farmer</h1>
			</div>
		</div><!--/.row-->
							...
							<div class="col-xs-12">
								<div class="row">
									...
									<div class="col-xs-10 col-md-10">
										 <div class="form-group">
        <input type="text" class="form-control" placeholder="Paste the question here" name="question" required  />
        </div>

										<div class="form-group">
          <label class="col-sm-6 control-label">Type the answer here</label>
          <div class="col-sm-12">
