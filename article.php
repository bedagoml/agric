...
$query = $MySQLi_CON->query("SELECT * FROM advice ");
// var_dump($users);
$MySQLi_CON->close();
...
<div class="container">
	<h3>Agricultural Advices</h3>
	<div class="col-md-12 w3l_nr2">
...
<div class="clearfix"></div>
	...
	<h4><?php echo $user['topic']; ?> </h4>
	<h5>By:<?php echo $user['username']; ?></h5>
<h6><?php echo $user['tarehe']; ?></h6>
...
<!-- footer -->
	...
	<!-- //footer -->
<div class="copyright">
 <p>&copy; Sowing Big 2019. All Rights Reserved | Design by <a href="bedagoml.github.io/online-CV" target="blank">Bedah</a></p>
 </div>
