...
<div class="banner" id="banner">
		<div class="top-nav w3-agiletop">
			<div class="container">
				<div class="navbar-header w3llogo">
					...
					<h1><a href="index.html">Sowing Big</a></h1> 
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<div class="w3menu navbar-left">
						<ul class="nav navbar">
							...
							<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span data-letters="Pages">Advices</span><span class="caret"></span></a>
								<ul class="dropdown-menu"> 
									<li><a href="article.php">Farmers Advice</a></li>
									<li><a href="quiz.php" >Ask question</a></li>
									<li><a href="ans.php" >Answered questions</a></li>
								</ul>
							</li>  
		...
		<!-- //navigation --> 
		<div class="logo">
					<h2>AGRICULTURAL ADVICES</h2>
					<p>The best platform to learn and get great ideas on farming.</p> <br>
					<p>Never let your farm dictate you woth sadness, make it sprout and earn the highest yield ever.</p>
				</div>
				<div class="container">
					<ul class="rslides" id="slider3">
						<li>
							<div class="slider-info">
								...
								<h3>Fertilizers advice</h3>
								</div>
								</div>
								<div class="col-md-3 w3_b4">
								<div class="w3_gap3">
								<i class="fa fa-male" aria-hidden="true"></i>
								<h3>Livestock advice</h3>
								</div>
								</div>
							</div>
						</li>
...
<h4>What We Are</h4>
<h5>Agriculture is our wisest Persuit</h5>
<p>We are truth seekers and determined to help our farmers achieve what they want.</p>
</div>
<div class="col-md-6 w3_abl">
<h4>What We Do</h4>
<h5>We get knowledgeable and share</h5>
<p>Ever wondered the power of sharing. This is it, get empowered at the comfort of your phone and enjoy the better yield that the neighbour will be left wondering.</p>
</div>
<div class="col-md-6 w3_abl">
<h4>Mission</h4>
...
<p>Our benefits is when the country grows big and export more making more revenues that pays us up.</p>
<div class="wthree_rm">
</div>
</div>
</div>
...
<div class="col-md=6 w3l_abtr">
<p>We have values and create them too, to nature a farmer to be productive is our ultimate goal.</p>
<div class="wthree_rm">
</div>
</div>
</div>
		...
		<div class="container">
			<div class="stats1">
				...
				<div class="w3-stats">
					...
					<h4><span class='numscroller' data-min='1' data-max='2451' data-delay='5' data-increment='3'>3386</span></h4>
					<p>Reviews</p>
				</div>
			</div>
			<div class="stats2">
...
<!-- gallery -->
	...
	<div class="container">
		...
		<div class="w3agile_gallery_grids">
					...
					<a class="sb" href="images/g11.jpg" title="Agriculture">
						<figure>
							...
							<figcaption>
								<h4>Sowing</h4>
								<p>
									Embracing high yields through better advices
								</p>
							</figcaption>
						</figure>
					</a>
			...
			<div class="col-md-3 w3agile_gallery_grid">
				<div class="w3agile_gallery_image">
					<a class="sb" title="Agriculture" href="images/g14.jpg">
						<figure>
			...
			<div class="col-md-3 w3agile_gallery_grid">
				<div class="w3agile_gallery_image">
					<a class="sb" title="Agriculture" href="images/g15.jpg">
						<figure>
			...
			<div class="col-md-3 w3agile_gallery_grid">
				<div class="w3agile_gallery_image">
					<a class="sb" title="Agriculture" href="images/g16.jpg">
						<figure>
			...
			<div class="col-md-3 w3agile_gallery_grid">
				<div class="w3agile_gallery_image">
					<a class="sb" title="Agriculture" href="images/g17.jpg">
						<figure>
			...
			<div class="col-md-3 w3agile_gallery_grid">
				<div class="w3agile_gallery_image">
					<a class="sb" title="Agriculture" href="images/g18.jpg">
						<figure>
