...
<html class="no-js">
    ...
    <head>
        <title>Admin - Dashboard <?php echo $row['userEmail']; ?></title>
        <!-- Bootstrap -->
        ...
        <div class="navbar navbar-fixed-top">
            <!-- <div class="navbar-inner"> -->
                <div class="container-fluid">
                    <a class="btn btn-navbar" data-toggle="" data-target=""> <span class="icon-bar"></span>
                     <span class="icon-bar"></span>
                     <span class="icon-bar"></span>
                    </a>
                    <a class="brand" href="#">Agriculture online Advisor</a>
                    <div class="brand">
                        
                        <ul class="navbar-brand nav pull-right ">
                            <li >
                                <a href="index1.php">Home</a>
                            </li>
                           
                            <li>  <a href="">Post Advice</a>
                            </li>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="feedback.php">Give feedback to anwers</a></li>
